...
from modules import UnFlatten, GLU, upBlock, Spatial_Attn, Channel_Attn, Decoupling_Attn
...
class Attn(nn.Module):
    def __init__(self, word_emb=512, img_hw=32, img_channel=128):
        ...
        self.channel_attn = Channel_Attn(img_channel, img_hw, img_hw)
        self.spatial_attn = Spatial_Attn(word_emb, img_hw, img_channel)
        self.conv = block3x3(img_channel*2, img_channel)

    def forward(self, img_feat, word_emb):
        img_feat = self.channel_attn(img_feat)
